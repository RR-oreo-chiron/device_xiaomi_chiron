...
PRODUCT_COPY_FILES += \
    ...
    $(call find-copy-subdir-files,*,$(LOCAL_PATH)/prebuilt/vendor,vendor) \
    $(call find-copy-subdir-files,*,$(LOCAL_PATH)/prebuilt/root,root) \
    $(LOCAL_PATH)/prebuilt/root/fstab.qcom:$(TARGET_COPY_OUT_VENDOR)/etc/fstab.qcom
...
#   android.hardware.camera.provider@2.4-service.chiron \
